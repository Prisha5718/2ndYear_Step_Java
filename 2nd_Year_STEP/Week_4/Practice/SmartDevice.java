public class SmartDevice {
    ...
    public static void main(String[] args) {
        ...
        SmartDevice d1 = new SmartDevice("Light", "Living Room", false, 10.5);
        SmartDevice d2 = new SmartDevice("Speaker", "Bedroom", true, 25.0);

        d1.setOnline(true).connectToDevice("Alexa").rename("Smart Light");
        d2.updateLocation("Kitchen");
        d2.updatePowerConsumption(30.0);
        d2.performInitialSetup();
